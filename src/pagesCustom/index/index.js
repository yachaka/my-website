...
class IndexPage extends PureComponent {
  constructor(props) {
    ...
    /* Habx sharp images */
    this.experiencesWebsite.habx.laptopScreenshots.homeConfigure.data = props.data.habxConfigurateur.childImageSharp.gatsbyImageData;
    this.experiencesWebsite.habx.laptopScreenshots.homeConfigureOpened.data = props.data.habxConfigurateurPanelOuvert.childImageSharp.gatsbyImageData;
    this.experiencesWebsite.habx.feedback.picture = props.data.guillaume.childImageSharp.gatsbyImageData;

    /* Spendesk sharp images */
    this.experiencesWebsite.spendesk.laptopScreenshots.requests.data = props.data.requestsScreenImg.childImageSharp.gatsbyImageData;
    this.experiencesWebsite.spendesk.laptopScreenshots.spends.data = props.data.paymentsScreenImg.childImageSharp.gatsbyImageData;
    this.experiencesWebsite.spendesk.laptopScreenshots.cards.data = props.data.cardsScreenImg.childImageSharp.gatsbyImageData;
    // this.experiencesWebsite.spendesk.laptopScreenshots.cardOrder.data = props.data.cardOrder3ScreenImg.childImageSharp.gatsbyImageData;
    this.experiencesWebsite.spendesk.laptopScreenshots.members.data = props.data.settingsTeamScreenImg.childImageSharp.gatsbyImageData;
    // this.experiencesWebsite.spendesk.laptopScreenshots.branches.data = props.data.branchsMenuScreenImg.childImageSharp.gatsbyImageData;
    this.experiencesWebsite.spendesk.feedback.picture = props.data.guilhem.childImageSharp.gatsbyImageData;
  ...
  render() {
    ...
    const page = {
      title: {
        fr: `Développeur fullstack senior - Ilyes Hermellin - React, Node.js, GraphQL, React Native, JavaScript, AWS, Docker et plus`,
        en: `Senior Fullstack Developer - Ilyes Hermellin - React, Node.js, GraphQL, React Native, JavaScript, AWS, Docker and more`,
      },
      description: {
        fr: 'Je suis un développeur fullstack senior. Je sais également gérer un projet, ou créer des designs basiques. Mes expériences professionnelles/mon CV, ma disponibilité et mon TJM sont sur mon site web !',
        en: `I am a senior fullstack developer. I also know how to manage a project, and create basic designs. Work experience, resume, avaibility and rate are on my website!`,
      },
    };
