...
import * as s from './ProjectFold.module.scss';
...
function ProjectFold({
  ...
  const allMedias = useMemo(() => ([
    ...(mobileScreenshots ? Object.values(mobileScreenshots) : []),
    ...(laptopScreenshots ? Object.values(laptopScreenshots) : []),
  ]), [mobileScreenshots, laptopScreenshots]);
              ...
              if (o.data.images) {
                return (
                  <a
                    ...
                    <GatsbyImage image={o.data} class={s.galleryDemoItem_img} />
                  </a>
                );
              } else if (o.data.video) {
                return (
                  ...
                  >
                    <img src={o.data.poster} class={s.galleryDemoItem_img} />
                  </a>
                )
              }
            })}
